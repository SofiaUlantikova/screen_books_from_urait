...
def get_data_and_start():
    ...
    def mousePoints(event, x, y, flags, params):
        ...
        if counter == 0:
            ...
            if event == cv2.EVENT_LBUTTONUP:
                ...
                point_matrix_temporal[counter] = x, y
                temp = img.copy()
                cv2.rectangle(temp, (point_matrix_temporal[0][0], point_matrix_temporal[0][1]),
                              (point_matrix_temporal[1][0], point_matrix_temporal[1][1]), (255, 155, 0), 2, 8)
            ...
            while page_existence:
                ...
                screenshot_cropped = im_screen[starting_y:ending_y,
                                     starting_x:ending_x]  # crop rectangle as a user selected
    ...
    def screen_page(num_page, url_of_book, time_delay=10):
        ...
        driver.save_screenshot('./page' + str(num_page) + '.png')
    screen_page(first_page, url_of_book)
    # Read image
